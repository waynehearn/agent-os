...
- `examples/quickstart/` - Main demo folder
  - `site/` - Frontend files (HTML/CSS/JS)
    - `index.html` - Main demo page with badge container
    - `app.js` - JavaScript module that renders SVG badge
    - `styles.css` - Minimal styling for demo
  - `.agent-os/` - Configuration and standards
    - `standards/tech-stack.md` - Tech stack definitions
    - `product/mission-lite.md` - Project mission
  - `README.md` - Setup and usage instructions
  - `initial-request.md` - Prefilled create-spec request
