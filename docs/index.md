...
3. Create Spec (by example)
	- [create-spec-usage.md](./create-spec-usage.md) → Use the Jira-driven Web API example block
4. Validate & test
...
- Agent OS website: [buildermethods.com/agent-os](https://buildermethods.com/agent-os)
